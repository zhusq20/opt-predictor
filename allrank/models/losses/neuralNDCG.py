...
def log_base_b(x, b):
    return torch.log(x) / torch.log(torch.tensor(b, dtype=x.dtype))
...
def neuralNDCG(y_pred, y_true, padded_value_indicator=PADDED_Y_VALUE, temperature=1., powered_relevancies=True, k=None,
    ...
    # print(P_hat.dtype)  # Print data type of P_hat
    # print(y_true_masked.dtype)  # Print data type of y_true_masked
